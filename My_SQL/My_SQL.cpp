...
//	if (query.empty())
//	{
//		cout << "datark inchi es enter talis???" << endl;
//		return false;
//	}
//	else if (firstWord != _CREATE_CMD && firstWord != _INSERT_CMD
//		&& firstWord != _DROP_CMD && firstWord != _DELETE_CMD && firstWord != _UPDATE_CMD)
//	{
//		cout << "ankap hrammanner mutq mi ara!!!" << endl;
//		return false;
//	}
//	else return true;
//}
// bool MySQL::exist(std::map<string, bool>& map)
//{
//	if (map.find(_QUERY[name]) != map.end())
//		return true;
//	return false;
//}
// bool MySQL::FileExists(const std::string& name) {
//	ifstream f(name + ".txt");
//	return f.good();
//}
//vector<string> MySQL::parse(string other) // hatuk &-ov chem poxancel
//{
//	while (!other.empty())
//	{
...
//	File.open(name + ".txt");
//}
//void MySQL::write_in_file(const string& name)
//{
//	fstream FDB;
//	FDB.open(name + ".txt", std::ios_base::app);
//	FDB << "\n^\n";
//	for (int i = data_start; i < _QUERY.size(); i++)
//	{
//		FDB << get_data_name(_QUERY[i]) << "=" << get_data_value(_QUERY[i]) << endl;
//	}
//	FDB << "^\n";
//}
//
//
//
//void MySQL::delete_all_found(const vector<string>& other)
//{
//	fstream FDB;
//	string fileName = (other[name] + ".txt").c_str();
//	FDB.open(fileName);
//	string tmp;
...
//	}
//	FDB.close();
//	remove_if(result.begin(), result.end(), must_be_deleted);
//	write_after_operation(result, fileName);
//}
//
///*void MySQL::update_all_found(const vector<string>& other);
//{
//	fstream FDB;
//	string fileName = (other[name] + ".txt").c_str();
//	FDB.open(fileName);
...
//}*/
//
//bool MySQL::drop_table(const string& name)
//{
//	std::string tmp = name + ".txt";
//	return	remove(tmp.c_str()); // remove expecte char*
//}
//
//string MySQL::get_data_name(string other)
//{
//	return other.substr(0, other.find("="));
//}
//string MySQL::get_data_value(string other)
//{
...
MySql::MySql()
{
	...
	//std::string path = "C:\\Users\\Nvard Petrosyan\\source\\repos\\My_SQL\\My_SQL";
